...
export const POPULAR_AIRPORTS = [
  ...
  { code: 'BOS', city: 'Boston', country: 'United States', name: 'Boston Logan Intl' },
  ...
  { code: 'YUL', city: 'Montreal', country: 'Canada', name: 'Trudeau Intl Airport' },
  ...
  { code: 'LIM', city: 'Lima', country: 'Peru', name: 'Jorge Chávez Intl' },
  { code: 'BOG', city: 'Bogotá', country: 'Colombia', name: 'El Dorado Intl Airport' },
  ...
  { code: 'VIE', city: 'Vienna', country: 'Austria', name: 'Vienna Intl Airport' },
  ...
  { code: 'KWI', city: 'Kuwait City', country: 'Kuwait', name: 'Kuwait Intl Airport' },
  { code: 'BAH', city: 'Manama', country: 'Bahrain', name: 'Bahrain Intl Airport' },
  { code: 'AMM', city: 'Amman', country: 'Jordan', name: 'Queen Alia Intl' },
  ...
  { code: 'PEK', city: 'Beijing', country: 'China', name: 'Capital Intl Airport' },
  { code: 'PVG', city: 'Shanghai', country: 'China', name: 'Pudong Intl Airport' },
  { code: 'HKG', city: 'Hong Kong', country: 'Hong Kong', name: 'Hong Kong Intl' },
  { code: 'TPE', city: 'Taipei', country: 'Taiwan', name: 'Taoyuan Intl Airport' },
  ...
  { code: 'DUR', city: 'Durban', country: 'South Africa', name: 'King Shaka Intl' },
  { code: 'CAI', city: 'Cairo', country: 'Egypt', name: 'Cairo Intl Airport' },
  { code: 'RAK', city: 'Marrakech', country: 'Morocco', name: 'Menara Airport' },
  { code: 'CMN', city: 'Casablanca', country: 'Morocco', name: 'Mohammed V Intl' },
  ...
  { code: 'ABJ', city: 'Abidjan', country: 'Ivory Coast', name: 'Port Bouet Airport' },
  { code: 'DSS', city: 'Dakar', country: 'Senegal', name: 'Blaise Diagne Intl' },
  ...
  { code: 'KGL', city: 'Kigali', country: 'Rwanda', name: 'Kigali Intl Airport' },
  { code: 'EBB', city: 'Entebbe', country: 'Uganda', name: 'Entebbe Intl Airport' },
  { code: 'HRE', city: 'Harare', country: 'Zimbabwe', name: 'Harare Intl Airport' },
  { code: 'MRU', city: 'Mauritius', country: 'Mauritius', name: 'Sir Seewoosagur Ramgoolam' },
  { code: 'SEZ', city: 'Seychelles', country: 'Seychelles', name: 'Seychelles Intl' }
];
